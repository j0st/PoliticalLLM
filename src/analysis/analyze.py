...
def get_descriptives(answers: list):
    ...
    grouped.to_csv('Results_Test25_03_07.csv', index=False)

    with open('Results_Test25_03_07.csv', mode='r') as file:
